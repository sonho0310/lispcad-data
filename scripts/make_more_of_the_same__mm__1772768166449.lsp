;; ====================================
;; TITLE: Make More of the Same (MM)
;; DESCRIPTION: Tạo đối tượng mới cùng loại và kế thừa thuộc tính (Layer, Color...) từ mẫu.
;; GUIDE: Load Lisp (AP) -> Gõ MM -> Chọn đối tượng mẫu -> Vẽ tiếp.
;; ====================================
(defun C:MM
